...
The repository's focused CUDA probe used PyTorch 2.13.0+cu126 on an RTX 4050 with 5.997 GiB usable. The redesigned width-64 family model at batch 8 completed 48 growth + 32 persistence steps, structural/counterfactual losses, backward, clipping, and Adam in 1.059 seconds, peaking at 3088.5 MiB allocated / 3276.0 MiB reserved. Although a clean-process batch-4 probe completed 64 + 96 steps, allocator fragmentation made that horizon unreliable in the full regeneration process. The regeneration and environment presets therefore cap the retained differentiable horizon at 96 steps; long 512-step validation remains no-gradient. Those numbers establish a practical preset envelope, not end-to-end training duration, convergence, or morphology quality.
